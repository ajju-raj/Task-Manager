                ...
                <div className="w-1/3 bg-[#ffe5e5] p-6 border-r-4 border-[#f76c6c] flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button 
                            ...
                            onClick={() => setActivePage("Daily Task")}
                        >
                            Daily Task
                        </button>
                        <button 
                            className={`w-full text-lg font-semibold py-4 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 ${
                                activePage === "Weekly Task" 
                                    ? "bg-[#f76c6c] text-white shadow-lg" 
                                    : "bg-white text-[#f76c6c] hover:bg-[#f76c6c] hover:text-white"
                            }`}
                            onClick={() => setActivePage("Weekly Task")}
                        >
                            Weekly Task
                        </button>
                        <button 
                            className={`w-full text-lg font-semibold py-4 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 ${
                                activePage === "Monthly Task" 
                                    ? "bg-[#f76c6c] text-white shadow-lg" 
                                    : "bg-white text-[#f76c6c] hover:bg-[#f76c6c] hover:text-white"
                            }`}
                            onClick={() => setActivePage("Monthly Task")}
                        >
                            Monthly Task
                        </button>
                        <button 
                            className={`w-full text-lg font-semibold py-4 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 ${
                                activePage === "Yearly Task" 
                                    ? "bg-[#f76c6c] text-white shadow-lg" 
                                    : "bg-white text-[#f76c6c] hover:bg-[#f76c6c] hover:text-white"
                            }`}
                            onClick={() => setActivePage("Yearly Task")}
                        >
                            Yearly Task
                        </button>
                    </div>
